...
public class ArticleDetailFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        collapsingToolbar.setTitle("No Title");
    ...
    private void bindViews() {
        ...
        if (mCursor != null) {
            ...
            // Read photo from cursor
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                startPostponedEnterTransition();
            }
            byte[] photo_url = mCursor.getBlob(ArticleLoader.Query.PHOTO_URL);
            ByteArrayInputStream imageStream = new ByteArrayInputStream(photo_url);
            Bitmap theImage= BitmapFactory.decodeStream(imageStream);
            mPhotoView.setImageBitmap(theImage);
        } else {
